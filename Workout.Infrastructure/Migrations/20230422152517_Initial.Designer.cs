...
namespace Workout.Infrastructure.Migrations
{
    ...
    [Migration("20230422152517_Initial")]
                    ...
                    b.OwnsMany("Workout.Domain.WorkoutPlan.Entities.WorkoutPlanSection", "Sections", b1 =>
                        {
                            ...
                            b1.OwnsMany("Workout.Domain.WorkoutPlan.Entities.WorkoutPlanExercise", "Exercises", b2 =>
                                {
                                    ...
                                    b2.ToTable("WorkoutPlanExercises", (string)null);
